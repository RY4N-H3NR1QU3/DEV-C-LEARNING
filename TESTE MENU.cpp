...
main() 
{
	...
	if((op==4)) 
	{
		...
		printf("\nDIGITE 7 ÁREA TRIÂNGULO QUALQUER");
		printf("\n\nESCOLHA: "),scanf("%d",&op);
					...
					if(op==4)
					{
						...
						if(op==5)
						{
							...
							if(op==6)
							{
								...
								{
									printf(RED BLUB"\n\t\t\t\t\t\t*****************************************");
									printf(RED BLUB"\n\t\t\t\t\t\t*VOCÊ SELECIONOU ÁREA TRIÂNGULO QUALQUER*");
									printf(RED BLUB"\n\t\t\t\t\t\t*****************************************");
									printf(MAGEN"\n<><><><><><><><><><><><><>");
									float A,B,C,SP,AREA;
									printf(WHT"\nINSIRA O LADO A:"),scanf("%f",&A);
									printf(WHT"INSIRA O LADO B:"),scanf("%f",&B);
									printf(WHT"INSIRA O LADO C:"),scanf("%f",&C);
									SP=(A+B+C)/2;
